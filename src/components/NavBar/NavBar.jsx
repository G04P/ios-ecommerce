    ...
    <nav className="bg-gray-800 p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <ul className="hidden lg:flex space-x-4">
          ...
          <li>
            <Dropdown className="text-white hover:text-gray-300" />
          </li>
          <li>
            <Link
        ...
        <div className="flex mx-3 p-2">
          <Link
            ...
            className="text-white mx-2 mt-3 hover:text-gray-300"
          >
            Login
          </Link>
          <Link
          ...
          >
            <button className="mt-7 bg-gray-800 text-white font-bold py-53 px-2 rounded-full">
